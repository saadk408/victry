...
const templates = {
  modern: {
    ...
    jobTitle: "text-xl text-gray-700 mt-1",
    contactInfo: "flex flex-wrap mt-3 text-sm text-gray-600",
    sectionTitle:
  ...
  professional: {
    ...
    name: "text-3xl font-bold text-gray-900 uppercase tracking-wide",
    jobTitle: "text-xl text-gray-600 mt-1",
    contactInfo: "flex justify-center flex-wrap mt-3 text-sm text-gray-600",
    sectionTitle:
      "text-base font-bold text-gray-900 mb-3 uppercase border-b border-gray-300 pb-1",
    sectionContainer: "mb-6",
    experienceTitle: "font-bold text-gray-800",
    experienceCompany: "font-medium text-gray-700",
    experienceDate: "text-gray-600 italic",
  ...
  minimal: {
    ...
    jobTitle: "text-gray-600",
    contactInfo: "flex flex-wrap mt-1 text-sm text-gray-600 space-x-3",
    sectionTitle:
      "text-sm uppercase tracking-wider font-bold text-gray-500 mb-3",
    sectionContainer: "mb-6",
    experienceTitle: "font-medium",
    experienceCompany: "text-gray-600",
    experienceDate: "text-gray-500 text-sm",
  ...
  creative: {
    ...
    contactInfo: "mt-2 flex flex-wrap text-sm text-gray-600",
    ...
    experienceCompany: "text-gray-700",
    experienceDate: "text-gray-600 text-sm",
    skillBadge:
